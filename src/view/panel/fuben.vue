      ...
      <div id="certify" class="container">
        ...
        <swiper :options="swiperOption">
          <swiper-slide v-for="n in 5" :key="n">
            <img src="https://www.swiper.com.cn/demo/certify/images/certify01.png" class="swiper" />
          </swiper-slide>
        </swiper>
      </div>
...
<script>
import { warningChart, equipChart, alarmChart } from '@/const/rescue';
