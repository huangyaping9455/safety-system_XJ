      ...
      <div class="guide-m-top">
        <div class="topItem">
          ...
          <div class="text">
            ...
            <div>
              <p>{{ vehicleCount.OnLineCount || 0 }}</p>
              <p>在线车辆</p>
            </div>
          </div>
        </div>
      ...
      <div class="guide-m-bottom">
        ...
        <div class="m-bottom-r">
          ...
          <div class="btns">
            ...
            <i-button
              class="btn-item"
              @click="showSevenAlarmStatistics('bdweichulishu')"
              type="primary"
              shape="circle"
              :ghost="activeName == 'bdweichulishu' ? false : true"
              >北斗设备</i-button
            >
            <i-button
              class="btn-item"
              @click="showSevenAlarmStatistics('sbweichulishu')"
              type="primary"
              shape="circle"
              :ghost="activeName == 'sbweichulishu' ? false : true"
              >主动安全设备</i-button
            >
          </div>
  ...
  methods: {
    ...
    getQYVehicleCount() {
      QYVehicleCount(this.$store.getters.deptId).then(({ data }) => {
        ...
        let OnLineCount = data.data.length > 0 ? data.data[0].OnLineCount : 0;
        let RegisterCount =
