...
import { internalTableConfig } from '@/const/operation';
import { getlistLirun } from '@/api/operation/report';
export default {
  name: 'Internal-check',
  mixins: [table],
  data() {
    return {
      level: 1,
      isSearch: false,
      table: this.tableInit(internalTableConfig)
    };
  },
  computed: {
    buttons() {
